...
with st.container():
    ...
    with left_column:
        st.write(
            ...
            - Display Name: Bagus Yuyun Kurniawan Wicaksono
            - User Principal Name: bagus.wicaksono@gobel.co.id
            - Model Name: Laptop Legion Pro 5 16IRX9
            - PC Name: IIAPG-Bagus
            - Laptop Code: IIAPG-NB24-005
            - Job Title: Test Course Officer
            - Department: IIAPG
            - Email: bagusyuyun@outlook.com
